...
class variables:
    DELTA_T = 10
    TEMPERATURE_P50 = (
        "AR6 climate diagnostics|Surface Temperature (GSAT)|MAGICC7|50.0th Percentile"
    )
    TEMPERATURE_P66 = (
        "AR6 climate diagnostics|Surface Temperature (GSAT)|MAGICC7|67.0th Percentile"
    )
    RF_P50 = (
        "AR6 climate diagnostics|Effective Radiative Forcing|MAGICC7|50.0th Percentile"
    )
    RF_P66 = (
        "AR6 climate diagnostics|Effective Radiative Forcing|MAGICC7|67.0th Percentile"
    )
    CO2 = "Emissions|CO2"
    CH4 = "Emissions|CH4"
    N2O = "Emissions|N2O"
